    ...
    <div className='flex flex-col gap-1 mb-4'>
      ...
      <div className='relative'>
        <input
          {...rest}
          id={text}
          className={`w-full bg-white/5 border ${error ? "border-red-500/70" : "border-white/10 focus:border-[#2eade7]/70"
            } rounded-xl px-4 py-2.5 text-white text-sm font-roboto outline-none transition-colors duration-200 placeholder:text-white/20 pr-9`}
        />
        {icon && (
