import { AngleRightIcon, PlayIcon, StarIcon } from "@/lib/icons/icons";
import { getBackdropSrcSet, getImagePath } from "@/lib/GetImagePath";
      ...
      <div className="flex w-full">
        {carouselData.map((data, i) => (
          ...
          >
            <img
              loading="lazy"
              src={getImagePath(780, data.backdrop_path)}
              srcSet={getBackdropSrcSet(data.backdrop_path)}
              sizes="100vw"
            ...
            <div className="flex gap-2 sm:gap-3 absolute z-30 left-[3%] sm:left-[4%] bottom-10 sm:bottom-11 items-end max-w-[85%]">
              <img
                src={getImagePath(92, data.poster_path)}
